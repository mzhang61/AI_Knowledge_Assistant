  ...
  <div class="app-layout">
    <div class="sidebar">
      <div class="logo-section">
        ...
        <span class="logo-text">Silicon Valley XiaoZhi（Assistant）</span>
      </div>
    ...
    <div class="main-content">
      <div class="chat-container">
        ...
        <div class="input-container">
          <el-input v-model="inputMessage" placeholder="Enter the message here" @keyup.enter="sendMessage"></el-input>
          <el-button @click="sendMessage" :disabled="isSending" type="primary">Send</el-button>
        </div>
      </div>
    </div>
  </div>
